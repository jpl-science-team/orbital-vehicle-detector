...
from mmdet.models.losses import L1Loss, FocalLoss
...
from projects.rotated_rtdetr.rotated_rtdetr import (RotatedRTDETR, RTDETRFPN,
                                                    RotatedRTDETRHead, ResNetV1dPaddle)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            type=FocalLoss,  # RTDETRVarifocalLoss in RTDETR
            use_sigmoid=True,
            gamma=2.0,
            alpha=0.25,
            loss_weight=1.0),
